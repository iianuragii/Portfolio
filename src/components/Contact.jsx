...
const Contact = () => {
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      {/* social icons */}
      <div className="flex ">
        <a href="https://www.linkedin.com/in/anurag-dutta-522777245/" target="_blank" rel="noreferrer">
          <img src={facebook} alt="" />
        </a>
        <a className="ml-4" href="https://github.com/iianuragii" target="_blank" rel="noreferrer">
        <img src={instagram} alt="" />
        </a>
        <a className="ml-4" href="imanurag18@gmail.com" target="_blank" rel="noreferrer">
        <img src={email} alt="" />
        </a>
      </div>
        </div>
        {/* form */}
        <div className="md:w-1/2">
            <p className="mt-16 text-white text-2xl mb-6">Send message</p>
            <form>
